...
_pandoc/SecondDefinitions.% : PROJECT=SecondDefinitions
_pandoc/SecondDefinitions.% : TITLE="Formal Products of Box Model Objects II"
_pandoc/OtherDefinitions.% : PROJECT=Notes
_pandoc/OtherDefinitions.% : TITLE="Formal Products of Box Model Objects, Outtakes"
